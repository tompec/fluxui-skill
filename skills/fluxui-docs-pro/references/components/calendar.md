...
<flux:calendar
    multiple
    value="2026-09-02,2026-09-05,2026-09-15"
/>
```
...
```blade
<flux:calendar mode="range" value="2026-09-02/2026-09-06" />
```
