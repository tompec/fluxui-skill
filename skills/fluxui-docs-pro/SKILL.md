...
- **[Carousel](references/components/carousel.md)**: A horizontally scrolling row of slides with snap and edge-aware controls.
...
- **[Color picker](references/components/color-picker.md)**: Let users pick a color from a swatch palette, drag a saturation/value canvas, or paste a hex valu...
