...
<flux:radio value="system">System</flux:radio></flux:radio.group>
```
...
<flux:radio value="system" icon="computer-desktop">System</flux:radio></flux:radio.group>
```
...
<flux:radio value="system" icon="computer-desktop" /></flux:radio.group>
```